...
<section>
	<div class="row">
		<div class="container">
			<div class="col-sm-6">
				<h1  class="log-title"><i class="fa fa-edit"></i> Reset password</h1>
				<form class="signup-form" method="post">	
					<input class="inputfield" name="email-or-username" placeholder="Email or username" type="text" value="" />
					<input class="btn-submit" name="reset-password" type="submit" value="Reset password">
				</form>
			</div>
		</div>
	</div>
