           ...
           <div class="row">
			 <div class="container">
				...
				<div class="col-sm-6 product-info">
					<h2>Australian Beef</h2>	
					<p>Munchery chefs come from top restaurants. They bring mad skills, tons of passion, and expertise in a delicious array of cuisines.Munchery chefs come from top restaurants. They bring mad skills, tons of passion, and expertise in a delicious array of cuisines.</p>
					<input type="number" max="10" min="0">
					<a class="cartadd" href="" >Add to Cart</a>
